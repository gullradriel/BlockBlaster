 ...
 * https://github.com/FredBienvenu/SmartEnum
...
#define __N_ENUM_DECLARE_FUNCTION(__N_ENUM_FUNCTION, enum_name)                \
    __N_ENUM_FUNCTION(enum_name); // MACRO for function declaration (just add ;
                                  // after function)
...
#define __N_ENUM_FUNCTION_FROMSTRING_EX(enum_name)                             \
    enum_name N_ENUM_ENTRY(enum_name, fromStringEx)(const char *str_value,     \
                                                    int index)
